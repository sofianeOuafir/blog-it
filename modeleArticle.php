...
$article = $articleManager->get( & );
$categorie = $categorieManager->get( & );
$utilisateur = $utilisateurManager->get( & );
$image = $imageDescriptionManager->get( & );
$existeVideo = false;
...
<link href="../CSS/CSSIMPORTANT/modeleArticle.css" rel="stylesheet" type="text/css">
