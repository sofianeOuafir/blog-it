...
class articleManager
{
	...
	{
		$req = $this->_db->query('select * from consulter inner join article on article.id_article = consulter.id_article group by consulter.id_article order by sum(vue) DESC LIMIT 0,5');
	...
	{
		$req = $this->_db->prepare('select * from consulter inner join article on article.id_article = consulter.id_article WHERE article.id_categorie = ? group by consulter.id_article order by sum(vue) DESC LIMIT 0,5');
