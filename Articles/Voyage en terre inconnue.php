...
$article = $articleManager->get( 15 );
$categorie = $categorieManager->get( 2 );
$utilisateur = $utilisateurManager->get( 1 );
$image = $imageDescriptionManager->get( 333 );
$existeVideo = false;
...
<link href="../CSS/Articles/Voyage en terre inconnue.css" rel="stylesheet" type="text/css">
